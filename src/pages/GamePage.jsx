...
export default function GamePage() {
    ...
    const predatorAttackInProgress = useRef(false);
    ...
    const handlePredatorAttack = async (targetAnimalId) => {
        if (!predatorMode.active ||
            usedPredators.has(predatorMode.predatorId) ||
            predatorAttackInProgress.current) return;

        predatorAttackInProgress.current = true;
        ...
        try {
            ...
            predatorAttackInProgress.current = false;
